    ...
    <div class="container-fluid mx-3">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" 
                       href="${pageContext.request.contextPath}/ControlEnviosTienda?tarea=verTodos">Envíos</a>
                </li>
                ...
                <div class="dropdown mx-3 mt-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser3">
                        ...
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath}/ControlReporteEnvios?tarea=enviosRecibidos">Reporte de envíos recibidos</a></li>
                    </ul>
                </div>
            </ul>
            <form class="d-flex">
