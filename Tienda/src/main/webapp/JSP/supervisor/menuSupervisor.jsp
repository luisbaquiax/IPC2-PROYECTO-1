<%-- 
    ...
    Created on : 28/02/2023, 02:20:13
    Author     : luis
--%>
    ...
    <div class="container-fluid mx-3">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="${pageContext.request.contextPath}/ControlReportePedidosSupervisor?tarea=listarPedidos"">Ver listado de pedidos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/ControlReportePedidosSupervisor?tarea=reportePedidos">Reporte de pedidos</a>
                </li>
            </ul>
            <form class="d-flex">
