<%-- 
    Document   : incidenciasSolucionadas
    Created on : 12/03/2023, 02:03:49
    Author     : luis
--%>
...
<html lang="en">
    <head>
        ...
        <title>Incidencias solucionadas</title>
        ...
        <jsp:include page="menuBodega.jsp"></jsp:include>
            <div class="container mt-5">
                <div class="card-header">
                    <div class="text-center">
                        <h1>Lista de incidencias solucionadas</h1>
                        <hr>
                    </div>
                    <form class="row g-3" method="POST" action="${pageContext.request.contextPath}/ControlBodegaReporteIncidencias?tarea=listarIncidenciasSolucionadasTienda">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <br>
                        <a class="btn btn-primary mb-3" href="${pageContext.request.contextPath}/ControlBodegaReporteIncidencias?tarea=listarIncidenciasSolucionadas"> 
            ...
            <div class="card-body">
                <table id="storeTable" class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach items="${incidenciasSolucionadas}" var="incidenciaSolucionada">
                            <tr>
                                <td>${incidenciaSolucionada.id}</td>
                                <td>${incidenciaSolucionada.fecha}</td>
                                <td>${incidenciaSolucionada.codigoTienda}</td>
                                <td>${incidenciaSolucionada.estado}</td>
                            </tr>
                        </c:forEach>
                </table>
            </div>
