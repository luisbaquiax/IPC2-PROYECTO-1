...
<html lang="en">
    ...
    <body>
        <jsp:include page="menuAdministrador.jsp"></jsp:include>
            <div class="container mt-5">
                <div class="card-header">
                    ...
                    <div class="text-center">
                        <h1>Lista de usuarios de Tienda</h1>
                        <hr>
                    </div>
                    <div class="row">
                        <div class="col col-md-6">
                            <a href="#"
                               ...
                               data-bs-target="#modalAddUserTienda" 
            ...
            <div class="card-body">
                <table id="storeTable" class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach items="${usuariosTienda}" var="u">
                            <tr>
                                <td>${u.codigo}</td>
                                <td>${u.nombre}</td>
                                ...
                                <td>
                                    <a href="#"
                                       onclick="openEditUserTienda('${pageContext.request.contextPath}/ControlUsuariosTienda?tarea=openEdit&codigo=${u.codigo}')"
        ...
        <div class="modal fade" id="modalEditUserTienda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <jsp:include page="modalAddUserTienda.jsp"></jsp:include>
            <!-- boostrap-->
